#!/bin/bash
# Stage 4: Prepare agentic RL data (critic with tool use).
#
# Creates parquet files in VERL RL format for agentic/trajectory training
# with execute_sql and submit_solution tools.
#
# Usage:
#   bash scripts/data/stage4_prepare_rl_data.sh \
#     --train_data <train.jsonl> \
#     --train_schema <train_schema.jsonl> \
#     --dev_data <prompts.jsonl> \
#     --dev_schema <dev_schemas.jsonl> \
#     --output_dir <output_directory> \
#     [--max_samples 50] [--max_turns 5]
...
echo "============================================================"
echo "Stage 4: Prepare Agentic RL Data"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Done. Agentic RL parquets saved to: ${OUTPUT_DIR}"
echo "  - ${OUTPUT_DIR}/train_sql_debug.parquet"
echo "  - ${OUTPUT_DIR}/dev_sql_debug.parquet"
echo "Use these for Stage 4 training (agentic RL with tool use)."
echo "============================================================"
